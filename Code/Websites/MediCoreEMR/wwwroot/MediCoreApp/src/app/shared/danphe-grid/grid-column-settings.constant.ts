  ...
  static FixedAssetCellIconRenderer(params) {
    var template =
      params.data.IsFixedAssets == true
        ? `<b title="FixedAsset Item" style="background: #5eb868;border: 1px solid blue;border-radius: 60%;padding: 2px 4px;color: #f8f8f8;">F</b>`
        : "";
    return template;
  }
  static ColdStorageIconRenderer(params) {
    var template =
      params.data.IsColdStorageApplicable == true
        ? `<b title="Cold Storage Item" style="background: #5eb868;border: 1px solid blue;border-radius: 60%;padding: 2px 4px;color: #f8f8f8;">C</b>`
        : "";
    return template;
  }
...
Department:` +
  ...
  static FixedAssetCellRenderer(params) {
    ...
    if (
      ...
      template =
        `
      <a danphe-grid-action="send-to-maintenance" class="fa fa-wrench" title="Send to Maintenance Secition" aria-hidden="true" style="color: #5eb868!important; font-size: 18px;"></a>
      ` + template;
