...
export default class WARDGridColumns {
  ...
  static ColdStorageIconRenderer(params) {
    var template = (params.data.IsColdStorageApplicable == true) ? `<b title="Cold Storage Item" style="background: #5eb868;border: 1px solid blue;border-radius: 60%;padding: 2px 4px;color: #f8f8f8;">C</b>` : '';
    return template;
  }
